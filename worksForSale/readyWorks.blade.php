                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="{{ asset('/images/bg1.png') }}" alt="" style="width:100%;">
                        </div>
                        ...
                        <div class="item">
                            <img src="{{ asset('/images/bg3.png') }}" alt="" style="width:100%;">
                        </div>

                        <div class="item">
                            <img src="{{ asset('/images/bg4.png') }}" alt="" style="width:100%;">
                        </div>
                    </div>
                    <!-- Indicators -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="card2-footer">
                        ...
                        <div style="width:25%; margin:4px;">
                            <button class="cardButton" type="button"> <i class="fa fa-star"></i> </button>
                            <button class="cardButton" type="button"> <i class="fa fa-heart"></i> </button>
                        </div>
                    </div>
                    <div style="width 100%; display:flex; margin: -41px 0 30px 8px;">
                        <div style="width: 70%; display: flex; ">
                            <img src="{{ asset('/images/p2.png') }}" alt="" style="height:28px;"> &nbsp;&nbsp;
                            <h5>Jahid Hasan</h5>
                        </div>
                        <div style="width:30%; display: flex; " class="cardButton2">
                            <h5>
                                <a href=""><i class="fa fa-heart"> </i> </a> 25&nbsp;&nbsp;
                            </h5>
                            <h5>
                                <a href=""><i class="fa fa-eye"> </i> </a> 50k
                            </h5>
                        </div>
                    </div>
