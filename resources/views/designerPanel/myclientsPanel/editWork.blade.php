<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight dark:text-white">
            {{ __('Subsecription plan | Order - Submit Work') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col ">
                <div class="bg-white shadow-md rounded-3xl p-5 dark:bg-gray-900">
                    ...
                    <div class="mt-5">
                        <form action="{{route('subscriptiondesignerresource.update',$order->id)}}" method="post" enctype="multipart/form-data">
                         @method('put')
                            @csrf
                            ...
                            <div class="md:space-y-2 mb-3 flex flex-col inline-block flex">
                                ...
                                <div class="flex items-center py-6 block table">
                                    ...
                                    <div class="w-12 h-12 mr-4 flex-none rounded-xl border overflow-hidden">
                                        <img class="w-12 h-12 mr-4 object-cover"  id="imgUploded" src="{{asset('uploads/'.$order->work_image)}}">
                                    </div>
                                   <br>
                                    ...
                                    <br>
                                    @endif
                                    @if($order->work_status == 'need to edit' || $order->work_status == 'working on' )
                                    ...
                                    <input type="file" class="hidden" accept="image/x-png,image/jpg,image/jpeg" name="work_image" onchange="showImg(event)" required>
                                    @error('work_image')
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input type="file" accept="" name="work_file">
