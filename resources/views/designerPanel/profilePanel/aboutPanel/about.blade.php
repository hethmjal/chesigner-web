        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg">
                <main class="w-full">
                  <div class="container mx-auto px-4">
                    <img src="{{asset('uploads/'.Auth::user()->background_photo_path)}}" width="3000px" alt="">
                  </div>
                              ...
                              <div class="w-full lg:w-4/12 px-4 lg:order-1">
                                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                                  <div class="mr-4 p-3 text-center">
                                    @php
                                      $rate =   App\Models\Evaluation::where('designer_id',Auth::id())->avg('rate');
                                      
                                    @endphp
                                    <span class="text-xl font-bold block uppercase tracking-wide text-gray-600">{{count(Auth::user()->orders_work)}}</span><span class="text-sm text-gray-400">Orders</span>
                                  </div>
                                  <div class="mr-4 p-3 text-center">
                                  ...
                                  <div class="lg:mr-4 p-3 text-center">
                                    <span class="text-xl font-bold block uppercase tracking-wide text-gray-600">{{count(Auth::user()->comments)}}</span><span class="text-sm text-gray-400">Comments</span>
                                  </div>
                                </div>
                              </div>
                            </div>
