        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col ">
                <div class="bg-white shadow-md rounded-3xl p-5 dark:bg-gray-900">
                    ...
                    <div class="mt-5">
                        <form action="{{route('programdesignerresource.store')}}" method="post">
                            @csrf
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="number" name="experience">
                                    @error('experience')
                                    <p class="text-red-600">{{$message}}</p>
                                    @enderror
                                </div>
