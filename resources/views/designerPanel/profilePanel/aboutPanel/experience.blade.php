    ...
    <section class="container mx-auto p-6">
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
          <div class="text-center">
            <h2><strong class="text-black">{{ __('Experience list') }}</strong></h2>
          </div>
          <div class="mb-3">
            ...
            <table class="w-full">
              ...
              <tbody class="bg-white">
                ...
                <tr class="text-gray-700">
                    ...
                    <td class="px-4 py-3 text-sm border-t"><a class="text-white px-4 py-3 w-auto h-10 bg-blue-600 rounded-full hover:bg-blue-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" href="{{ url("/panels/DesignerPanel/MyProfile/experience/{$experince->id}/editExperience") }}">
                      {{ __('Edit') }}
                    </a></td>
                    <td class="px-4 py-3 text-sm border-t">
                    <form action="{{route('experiencedesignerresource.destroy',$experince->id)}}" method="POST">
                      @method('delete')
        ...
        <div class="mt-3">
            <a class="text-white px-4 py-2 mb-3 w-auto h-10 bg-green-600 rounded-full hover:bg-green-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" href="{{ url('/panels/DesignerPanel/MyProfile/experience/newExperience') }}">
