        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col ">
                <div class="bg-white shadow-md rounded-3xl p-5 dark:bg-gray-900">
                    ...
                    <div class="mt-5">
                        <form action="{{route('challengeuseresource.update',$challenge->id)}}" method="post" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <br>
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input type="text" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg"  value="{{$challenge->title}}" name="title" id="">
                                    @error('title')
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs c_type">
                            ...
                            <div class="md:space-y-2 mb-3">
                                ...
                                <div class="flex items-center py-6">
                                    ...
                                    <div class="w-12 h-12 mr-4 flex-none rounded-xl border overflow-hidden">
                                        <img class="w-12 h-12 mr-4 object-cover" src="{{asset('uploads/'.$challenge->image)}}" id="imgUploded" >
                            ...
                            <div class="md:space-y-2 mb-3">
                                <div class="flex items-center py-6">
                                    ...
                                    <div class=" mr-4 flex-none rounded-xl border overflow-hidden">
                                            <video id="blah"  @if (!$challenge->video)    class="hidden"    @endif  width="240" height="240" controls>
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                ...
                                @if ($challenge->audio_file)
                                   ...
                                   <div class="row audio_input">
                                    <a class="audio" href="javascribt:void(0);"><i class="fa fa-times-circle  " aria-hidden="true"></i> </a>
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input type="number" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg" value="{{$challenge->expert}}" name="expert" id="">
                                    @error('expert')
                                    <div class="relative px-4 py-3 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                        <p class="ml-6">{{$message}}</p>
                                      </div>
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input type="number" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg" value="{{$challenge->professional}}" name="professional" id="">
                                    @error('professional')
                                    <div class="relative px-4 py-3 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                        <p class="ml-6">{{$message}}</p>
                                      </div>
                                ...
                                <input type="hidden" class="challenge_id" value="{{$challenge->id}}" name="">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    <label class="font-semibold text-gray-600 py-2 dark:text-gray-100">{{ __('Ordinary Designer') }}<abbr title="required">*</abbr></label>
                                    <input type="number" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg" value="{{$challenge->ordinary}}" name="ordinary" id="">
                                    @error('ordinary')
                                    <div class="relative px-4 py-3 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                                        <p class="ml-6">{{$message}}</p>
                                      </div>
                            ...
                            <div id="designer" class=" md:flex flex-row md:space-x-4 w-full text-xs">
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input name="deadline"  class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" value="{{$challenge->deadline}}" min="2" max="10" type="number">
                                    @error('deadline')
                                    <div class="relative px-4 py-3 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                            ...
                            <div class="md:space-x-4 w-full text-xs">
                                ...
                                <textarea name="description" rows="10" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400">{!!$challenge->description!!} </textarea>
                                @error('description')
                                <div class="relative px-4 py-3 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input   name="data1" class="rounded-lg overflow-hidden appearance-none bg-gray-400 h-3 w-128" type="range"  min="0" max="100" step="5" value="{{$challenge->data->Classic}}" />
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input   name="data2" class="rounded-lg overflow-hidden appearance-none bg-gray-400 h-3 w-128" type="range"  min="0" max="100" step="5" value="{{$challenge->data->Symbolic}}" />
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input  name="data3" class="rounded-lg overflow-hidden appearance-none bg-gray-400 h-3 w-128" type="range"   min="0" max="100" step="5" value="{{$challenge->data->Unformal}}" />
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input  name="data4" class="rounded-lg overflow-hidden appearance-none bg-gray-400 h-3 w-128" type="range"  min="0" max="100" step="5" value="{{$challenge->data->Economy}}" />
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input name="data5" class="rounded-lg overflow-hidden appearance-none bg-gray-400 h-3 w-128" type="range"   min="0" max="100" step="5" value="{{$challenge->data->Geometreic}}" />
                            ...
                            <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                ...
                                <button class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500" type="submit">{{ __('Update') }}</button>
                            </div>
...
<script>
    ...
    $("div.mb-3 select").val(`<?php echo $challenge->design_type ;?>`).change();
    $("div.c_type select").val(`<?php echo $challenge->challenge_type ;?>`).change();
