        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col ">
                <div class="bg-white shadow-md rounded-3xl p-5 dark:bg-gray-900">
                    ...
                    <div class="mt-5">
                        <form action="{{route('educationdesignerresource.update',$education->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input placeholder="Specialization" value="{{$education->specialization}}" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="text" name="specialization">
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input placeholder="University / College /Institute name" value="{{$education->university}}" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="text" name="university">
                                    @error('university')
                                    <p class="text-red-600">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input placeholder="From (Date) address" value="{{$education->from}}"  class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="date" name="from">
                                    @error('from')
                                    <p class="text-red-600">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input placeholder="To (Date)" value="{{$education->to}}"  class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="date" name="to">
                                    @error('to')
                                    <p class="text-red-600">{{$message}}</p>
                                    @enderror
                                </div>
