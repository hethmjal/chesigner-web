        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg">
                <main class="w-full">
                  <div class="container mx-auto px-4">
                    <img src="{{asset('uploads/'.$user->background_photo_path)}}"  alt="">
                  </div>
                              ...
                              <div class="w-full lg:w-4/12 px-4 lg:order-1">
                                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                                  <div class="mr-4 p-3 text-center">
                                    <span class="text-xl font-bold block uppercase tracking-wide text-gray-600">{{count($user->orders)}}</span><span class="text-sm text-gray-400">{{__('Orders')}}</span>
                                  </div>
                                  <div class="mr-4 p-3 text-center">
                                    <span class="text-xl font-bold block uppercase tracking-wide text-gray-600">{{count($user->favorites)}}</span><span class="text-sm text-gray-400">{{__('Favorites')}}</span>
                                  </div>
                                  <div class="lg:mr-4 p-3 text-center">
                                    <span class="text-xl font-bold block uppercase tracking-wide text-gray-600">{{count($user->comments)}}</span><span class="text-sm text-gray-400">{{__('Comments')}}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="mt-10 py-10 border-t border-gray-200 text-center">
                            <div class="flex flex-wrap justify-center">
                              <div class="w-full lg:w-9/12 px-4">
                                <p class="mb-2 text-3xl text-gray-700 font-bold">{{ __('Subscription plans') }}</p>
                                <br>
                                <br>
                                <div class="grid grid-flow-col grid-cols-3 text-center">
                                  ...
                                  <div>
                                    <div class="relative flex flex-col justify-between p-8 lg:p-6 xl:p-8 rounded-2xl">
                                      ...
                                      <a href="{{url('/subscriptionplans/'.$package->id)}}" class="relative flex items-center justify-center w-full px-5 py-5 text-lg font-medium text-white rounded-xl group">
                                        ...
                                        <span class="relative">{{ __('View Designers') }}</span>
                                    </a>
                                    </div>
                                  </div>
                                  @endif
